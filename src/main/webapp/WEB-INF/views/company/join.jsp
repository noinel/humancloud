...
<body>
    ...
    <form action="/user/create" name="form" id="form" method="POST" onsubmit="return join()">
        ...
        <div class="small_container">
                <div class="userid_">
                        <input id="username" type="text" class="username form-control" name="username" placeholder="아이디"/>                                                               
                        <input type="button" class="btn btn-light" onclick="validateDuplicateID()" style="color:black" value="중복확인" >
                    </div>   
           
                <div><input id="name" type="text" class="form-control" name="name" placeholder="회사명"/></div>                                                                                                    
                         
                <div class="twopassword">
                    <input id="pw1" type="password" class="pw1 form-control" name="password" placeholder="패스워드" />
                    <input id="pw2" type="password" class="pw2 form-control" placeholder="패스워드 확인"/>
                </div>    
                ...
                <div><input id="telephone" type="tel" class="form-control" name="phone" placeholder="전화번호"/></div>                                                                                
                <div><input id="my_email" type="email" class="form-control" name="email" placeholder="이메일"/></div>                                                    
                <div><input id="rrn" type="text" class="form-control" name="number" placeholder="사업자 등록 번호"/></div>
                                                                                        
        </div>   
            <div><input type="text" name="role" value="company" style="visibility: hidden" readonly/> </div>
            <hr />
            <h3>회사  PR</h3>
