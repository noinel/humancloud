...
<body>
<script>
	let age = document.querySelector('#for_age');
	$(document).ready(function(){
		for(let i = 20; i<61; i++){
			let option = document.createElement('option');
			option.innerHTML = i;
			$('#for_age').append(option);
		}
	})
</script>
		<script>
    ...
    <div class="my_container">
            <form action="/resume/create" method="post" enctype="multipart/form-data" name="myForm" onsubmit="return join()">
            ...
            <div class="my_menu">
                <div class="my_info">
                    ...
                    <div><input type="text" class="form-control" readonly="readonly" value ="${user.addr }"required="required" disabled="disabled"></div> 
                      <div>
                        <select class="form-control age" name="age" id="for_age">                            
        ...
        <div class="resume">
                <div class="my_page2">
                    ...
                    <div class="search">
                      ...
                      <select class="form-control borough" required="required" name="gugun">
              ...
              <div>
                  <input id="zip" type="file" name="zip" class="form-control-file border" required="required"/>              
